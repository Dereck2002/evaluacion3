...
switch ($_GET["op"]) {
    ...
    case 'actualizar':
        ...
        $Precio_unitario = $_POST["Precio_unitario"];
        $datos = array(); //defino un arreglo
        $datos = $stocks->actualizar($ID_producto, $ID_proveedor, $Nombre_producto, $Cantidad, $Precio_unitario); //llamo al modelo de usuarios e invoco al procedimiento actual
        echo json_encode($datos); //devuelvo el arreglo en formato json
        break;
